export default {
  ...
  'universal-layout.menu.aicodecheck.mergeReview': 'Merge Review',
  'universal-layout.menu.aicodecheck.mergeReviewCreate': 'Create Task',
  'universal-layout.menu.aicodecheck.mergeReviewDetail': 'Task Detail',
